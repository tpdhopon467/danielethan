    ...
    <header class="d-print-none">
      <div class="container text-center text-lg-left">
        <div class="pt-4 clearfix">
          <h1 class="site-title mb-0">Daniel Ethan</h1>
          <div class="site-nav"> 
            <nav role="navigation">
...
<div class="resume-container">
      ...
      <div class="cover bg-image"><img src="images/header-background.jpg"/>
        <div class="mask" style="background-color: rgba(0, 0, 0, 0.7);backdrop-filter: blur(2px);">
          <div class="text-center p-5">
            <div class="avatar p-1"><img class="img-thumbnail shadow-2-strong" src="images/danielethan.png" width="160" height="160"/></div>
            <div class="header-bio mt-3">
              <div data-aos="zoom-in" data-aos-delay="0">
                <h2 class="h1">Daniel Ethan</h2>
              ...
              <div class="d-print-none"><a class="btn btn-outline-light btn-lg shadow-sm mt-1 me-3" href="https://drive.google.com/file/d/1YDIDeyE2P2EHG6HzyMV2SsIT2FGFQHMN/view" data-aos="fade-right" data-aos-delay="700">Download CV</a><a class="btn btn-info btn-lg shadow-sm mt-1" href="#contact" data-aos="fade-left" data-aos-delay="700">Hire Me</a></div>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="shadow-1-strong bg-white my-5 p-5" id="about">
    <div class="about-section">
      <div class="row">
        <div class="col-md-6">
          <h2 class="h2 fw-light mb-4" style="margin-top: 18px">About Me</h2>
          <div><div class="progress">
  <div class="progress-bar bg-important"  role="progressbar" aria-valuenow="70"
  aria-valuemin="0" aria-valuemax="100" style="width:70%">
    <span class="sr-only">70% Complete</span>
  </div>
</div></div><br>
          <p>Result oriented developer with programming experience in international projects including management, consulting, development,
training and сustomer relationship management. Extensive experience in delivering large-scale high load web projects owing to
strong development skills and cooperating with developers. Knowledge of Agile approaches to work with team on large projects and
using methodologies like Lean StartUp for quick discovering a successful business model. Being capable of developing large web
applications for years and creating MVP(minimum viable product) in a few days for startup testing by using special frameworks and
libraries. Cross cultural sensitivity, strong development skills and ability to get into new problems and solve them extremely quickly.</p>
        </div>
        <div class="col-md-5 offset-lg-1">
          <div class="row mt-2">
            <h2 class="h2 fw-light mb-4" style="margin-top: 10px">Bio</h2>
            <div><div class="progress">
  <div class="progress-bar bg-important" role="progressbar" aria-valuenow="70"
  aria-valuemin="0" aria-valuemax="100" style="width:70%">
    <span class="sr-only">70% Complete</span>
        ...
        <div class="col-md-6">
          <div class="mb-3"><span class="fw-bolder">jQuery</span>
            <div class="progress my-2 rounded" style="height: 20px">
              <div class="progress-bar bg-secondary" role="progressbar" data-aos="zoom-in-right" data-aos-delay="100" data-aos-anchor=".skills-section" style="width: 100%;" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100">Master</div>
            </div>
          </div>
          <div class="mb-3"><span class="fw-bolder">PHP</span>
            <div class="progress my-2 rounded" style="height: 20px">
              <div class="progress-bar bg-secondary" role="progressbar" data-aos="zoom-in-right" data-aos-delay="200" data-aos-anchor=".skills-section" style="width: 90%" aria-valuenow="90" aria-valuemin="0" aria-valuemax="90">Expert</div>
            </div>
          </div>
          <div class="mb-3"><span class="fw-bolder">Yii</span>
            <div class="progress my-2 rounded" style="height: 20px">
              <div class="progress-bar bg-secondary" role="progressbar" data-aos="zoom-in-right" data-aos-delay="300" data-aos-anchor=".skills-section" style="width: 80%" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100">Advance</div>
            </div>
          </div>
          <div class="mb-3"><span class="fw-bolder">React.js</span>
            <div class="progress my-2 rounded" style="height: 20px">
              <div class="progress-bar bg-secondary" role="progressbar" data-aos="zoom-in-right" data-aos-delay="300" data-aos-anchor=".skills-section" style="width: 85%" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100">Advance</div>
            </div>
          </div>
           <div class="mb-3"><span class="fw-bolder">Vue.js</span>
            <div class="progress my-2 rounded" style="height: 20px">
              <div class="progress-bar bg-secondary" role="progressbar" data-aos="zoom-in-right" data-aos-delay="300" data-aos-anchor=".skills-section" style="width: 100%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100">Master</div>
            </div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="mb-3"><span class="fw-bolder">React Native</span>
            <div class="progress my-2 rounded" style="height: 20px">
              <div class="progress-bar bg-secondary" role="progressbar" data-aos="zoom-in-right" data-aos-delay="400" data-aos-anchor=".skills-section" style="width: 95%" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100">Expert</div>
            </div>
          </div>
          <div class="mb-3"><span class="fw-bolder">AngularJS</span>
            <div class="progress my-2 rounded" style="height: 20px">
              <div class="progress-bar bg-secondary" role="progressbar" data-aos="zoom-in-right" data-aos-delay="400" data-aos-anchor=".skills-section" style="width: 95%" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100">Expert</div>
            </div>
          </div>
          <div class="mb-3"><span class="fw-bolder">Laravel</span>
            <div class="progress my-2 rounded" style="height: 20px">
              <div class="progress-bar bg-secondary" role="progressbar" data-aos="zoom-in-right" data-aos-delay="500" data-aos-anchor=".skills-section" style="width: 85%" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100">Advance</div>
            </div>
          </div>
          <div class="mb-3"><span class="fw-bolder">Node.js</span>
            <div class="progress my-2 rounded" style="height: 20px">
              <div class="progress-bar bg-secondary" role="progressbar" data-aos="zoom-in-right" data-aos-delay="600" data-aos-anchor=".skills-section" style="width: 95%" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100">Expert</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="timeline">
        <div class="timeline-card timeline-card-info" data-aos="fade-in" data-aos-delay="0">
          <div class="timeline-head px-4 pt-3">
            <div class="h5">Software Developer <span class="text-muted h6">at evozon</span></div>
          </div>
          <div class="timeline-body px-4 pb-4">
            <div class="text-muted text-small mb-3"> 2015 - 2019</div>
            <div>☆ Reated a program for line segment recognition in a noisy, interlaced video stream.<br> ☆ Created software for visually constructing and processing graphs using a set of implemented
image-processing algorithms.<br> ☆ Implemented 20+ mathematical image processing algorithms.<br> ☆ Gained experience in analyzing algorithms documentation and using it as instructions for
implementation.</div>
          </div>
        </div>
        <div class="timeline-card timeline-card-info" data-aos="fade-in" data-aos-delay="200">
          <div class="timeline-head px-4 pt-3">
            <div class="h5">implementation. Senior Web Developer, R&D Department Manager <span class="text-muted h6">at 3Pillar Global</span></div>
          </div>
          <div class="timeline-body px-4 pb-4">
            <div class="text-muted text-small mb-3"> 2010 - 2015</div>
            <div>☆ Created a web service software that provides e-polls for companies, by estimating staff involvement ratio, discovering organization strengths and weaknesses, and more.<br>
☆ Created an application for automated poll form recognition using image processing.<br>
☆ Gained experience in managing teams with diversely specialized members (IT specialists, designers, testers, business consultants, and clients).<br>
☆ Gained experience in resource estimation, project planning, and time management.</div>
          </div>
        </div>
        <div class="timeline-card timeline-card-info" data-aos="fade-in" data-aos-delay="400">
          <div class="timeline-head px-4 pt-3">
            <div class="h5">Full-stack Web Developer <span class="text-muted h6">at Fortech</span></div>
          </div>
          <div class="timeline-body px-4 pb-4">
            <div class="text-muted text-small mb-3"> 2005 -  2010</div>
            <div>☆ Created a web-based CRM for health insurance agents across the USA, with automated email notifications, status tracking, and specialized tools like template insurance offering.<br>
☆ Created a web search for health insurance plans based on US government insurance plans databases. The search included flexible filtering and adaptive cost estimation (age, smoking factor, annual income, and family members).<br>
☆ Built an editor for online courses, enabling education resources to be created with embedded videos, illustration images, formatted texts, and formulas.<br>
☆ Created an online portal for educational courses with flexible course access management (grouped access lists with tagged resource linkage). Also, the portal provides an environment for watching courses and tracking progress.</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="education-section">
      ...
      <div class="timeline">
        <div class="timeline-card timeline-card-success" data-aos="fade-in" data-aos-delay="0">
          <div class="timeline-head px-4 pt-3">
            <div class="h5">Bachelor of Science - BS <span class="text-muted h6">from Minsk State Linguistic University</span>         </div>
          </div>
          <div class="timeline-body px-4 pb-4">
            <div class="text-muted text-small mb-3">2001 - 2001</div>
      ...
      <div class="row"> 
        <div class="col-md-6">
          ...
          <div class="d-flex"><i class="text-secondary fas fa-quote-left"></i>
            <p class="lead mx-2" data-aos="fade-left" data-aos-delay="100">Daniel displays exemplary professionalism and is able to take on challenges. He learns quickly and is an asset to any team.</p>
          </div>
        </div>
        <div class="col-md-6">
          <div class="d-flex mb-2">
          ...
          <div class="d-flex"><i class="text-secondary fas fa-quote-left"></i>
            <p class="lead mx-2" data-aos="fade-left" data-aos-delay="100">Daniel is a great co-worker and problem solver. He is quick to extend his helping hand and makes a good team player.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="contant-section">
      ...
      <div class="row mb-4">
        <div class="col-md-5" data-aos="fade-left" data-aos-delay="200">
          <div class="mt-1">
            <div class="h6"><i class="fas fa-phone pe-2 text-muted" style="width:24px;opacity:0.85;"></i> +375-335-5586-28</div>
            <div class="h6"><i class="far fa-envelope pe-2 text-muted" style="width:24px;opacity:0.85;"></i> vpouuttipo2233@gmail.com</div>
          </div>
